...
//		return idlist.size();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    ...
	    if(convertView==null){
	      ...
	      holder.tvEndDT = (TextView)vi.findViewById(R.id.tvEndDT);
	      ...
	      //holder.tvCity.setText(weatherDataCollection.get(position).get("PROJECT_NAME"));
	      holder.tvCity.setText(weatherDataCollection.get(position).get("NAME"));
	      holder.tvWeather.setText(weatherDataCollection.get(position).get("BUG_ID"));
	      holder.tvTemperature.setText(weatherDataCollection.get(position).get("START"));
	      holder.tvEndDT.setText(weatherDataCollection.get(position).get("END"));
	      //Setting an image
